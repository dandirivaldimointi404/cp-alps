                        ...
                        <div class="header-caption">
                            ...
                            <div class="img-block mb-4 rounded-4"
                                ...
                                <div class="text-overlay"
                                    style="position: absolute; bottom: 0; left: 0; width: 100%; height: 40%; background-color: rgba(0, 0, 0, 0.5); color: #fff; display: flex; flex-direction: column; justify-content: center; align-items: flex-start; text-align: left; padding: 20px;">
                                    <small style="margin-bottom: 5px;">{{ $postBlog->kategori }}</small>
